...
<body>
    ...
    <div class="contenedorRT mt-4 miFontSize">
        ...
        <label class="m-0"><b>ResponsableSeguimiento: </b>{{$incidencias->ResponsableSeguimiento}}</label> <br>
    ...
    <div class="contenedorRT mt-4 miFontSize">
        <label class="minicontenedor"><b>Motivo: </b>{{$incidencias->ComentariosPa}}</label> <br>  
        <label class="minicontenedor"><b>Derivacion: </b>{{$incidencias->Derivacion}}</label> <br>
        <label class="minicontenedor"><b>Descripcion del incidencias: </b>{{$incidencias->DescripcionReporte}}</label> <br>
        <label class="minicontenedor"><b>Observaciones: </b>{{$incidencias->Observaciones}}</label> <br>
        <label class="minicontenedor"><b>Seguimiento: </b>{{$incidencias->Comentarios}}</label>
    </div>
